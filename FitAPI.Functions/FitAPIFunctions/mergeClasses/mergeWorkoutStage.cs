...
{
    public class mergeWorkoutStage
    {
        private readonly ILogger<mergeWorkoutStage> _logger;

        public mergeWorkoutStage(ILogger<mergeWorkoutStage> logger)
        {
            _logger = logger;
        }
	    [Function("mergeWorkoutStage")]
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = "merge/WorkoutStage")]HttpRequestData req)
		{
