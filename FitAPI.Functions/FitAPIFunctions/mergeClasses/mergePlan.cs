...
namespace FitAPIFunctions
{
    ...
    {
        private readonly ILogger<mergePlan> _logger;

        public mergePlan(ILogger<mergePlan> logger)
        {
            _logger = logger;
        }
	    [Function("mergePlan")]
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = "merge/Plan")]HttpRequestData req)
		{
