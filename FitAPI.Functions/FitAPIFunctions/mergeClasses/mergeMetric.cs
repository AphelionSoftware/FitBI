...
namespace FitAPIFunctions
{
    ...
    {
        private readonly ILogger<mergeMetric> _logger;

        public mergeMetric(ILogger<mergeMetric> logger)
        {
            _logger = logger;
        }
	    [Function("mergeMetric")]
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = "merge/Metric")]HttpRequestData req)
		{
