...
namespace FitAPIFunctions
{
    public static class MergeExercise3
    {
        ...
        public async static Task<HttpStatusCode> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = "merge/Exercise3")]HttpRequestMessage req, TraceWriter log)
        {
