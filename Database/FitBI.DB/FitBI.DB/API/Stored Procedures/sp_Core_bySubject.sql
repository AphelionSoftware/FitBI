...
-- Description:	Gets an Coreialisation load set, by using an Auth0 subject
-- =============================================
CREATE PROCEDURE [API].[sp_Core_bySubject]
...
BEGIN
	...
	END
	EXEC API.sp_Core @UserID = @UserID, @Version = @Version
END